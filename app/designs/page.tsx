...
export default function MyDesignsPage() {
  ...
  return <main className="min-h-screen bg-[#fffdf9] text-[#281c2d]">
    <header className="border-b border-[#281c2d]/8 bg-[#fffdf9]/95 backdrop-blur-xl"><nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10" aria-label="My Designs navigation"><Link href="/" className="flex items-center gap-3 rounded-lg font-semibold focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#7957a7]" aria-label="Cake Topper Designer home"><span className="grid size-9 place-items-center rounded-full bg-[#f57558] text-lg text-white">♡</span><span className="max-[380px]:sr-only">Cake Topper Designer</span></Link><Link href="/create" className="rounded-full bg-[#2d1d31] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#422d47] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7957a7]">Create Your Topper</Link></nav></header>
